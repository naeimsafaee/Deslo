...
$(document).ready(function () {
  ...
  if ($(".layout .sidebar").length) $(".layout .sidebar").mCustomScrollbar({
  ...
  if ($('#userchart').length) {
    var ctx = document.getElementById('userchart').getContext('2d'); //ctx.canvas.width = 200;
  ...
  $(".layout .main .notes .textbox textarea").on('input', function () {
    if ($(this).val() !== "") $('.layout .main .notes .textbox .bottom button').prop('disabled', false);else $('.layout .main .notes .textbox .bottom button').prop('disabled', true);
  });
  ...
  $('.form-group select').on('select2:opening', function (e) {
    ...
    if ($(this).parents('.form-group').hasClass('gray')) $(this).data('select2').$dropdown.addClass('gray');
  });
  $('.form-group select').on('select2:closing', function (e) {
    $(this).parents('.form-group').removeClass('open');
    if ($(this).parents('.form-group').hasClass('gray')) $(this).data('select2').$dropdown.removeClass('gray');
  });
  ...
  $('.form-addable .data').on('click', 'button.deleteform', function () {
    if ($(this).parents('.form-addable').find('.item').length > 1) $(this).parents('.item').fadeOut(500, function () {
      $(this).remove();
    });else $(this).parents('.form-addable').find('input,textarea').val('');
  });
  /* form group limited */
  ...
  $('.tablist .tabs button:not(.more),.tablist .tabs .more li').click(function () {
    ...
    if (!$(this).parents('.tablist').find('.tab.tab' + id).length) $(this).parents('.tablist').addClass('empty');
  });
  ...
  $('.tablesimple.tabs button:not(.more),.tablesimple.tabs .more li').click(function () {
    ...
    if (!$(this).parents('.databox').find('.tablesimple.tab.tab' + id).length) $(this).parents('.databox').addClass('empty');
  });
  ...
  $('table tbody tr td input[type=checkbox]').click(function () {
    if ($(this).prop('checked') === true) {
      ...
      if ($(this).parents('table').find('tbody tr td input[type=checkbox]:checked').length == 0) $('.layout .main .header .action button.delete').prop('disabled', true);
    }

    if ($(this).parents('table').find('tbody tr td input[type=checkbox]:checked').length > 1) $('.layout .main .header .action button.delete').text('Bulk Delete');else $('.layout .main .header .action button.delete').text('Delete');
  });
  ...
  $('.replaychat .sendbox textarea,.layout .main .content .support .sendbox textarea').focusin(function () {
    ...
    if ($(this).parents('.template').find('.templates .list').length) $(this).parents('.template').find('.templates .list').addClass('open');
    if ($(this).parents('.chatbox').find('.messages').length) $(this).parents('.chatbox').find('.messages').addClass('open');
  });
  $('.replaychat .sendbox textarea,.layout .main .content .support .sendbox textarea').focusout(function () {
    ...
    if ($(this).parents('.template').find('.templates .list').length) $(this).parents('.template').find('.templates .list').removeClass('open');
    if ($(this).parents('.chatbox').find('.messages').length) $(this).parents('.chatbox').find('.messages').removeClass('open');
  });
  ...
  $('.table tbody tr td button.openchat').click(function () {
    ...
    if (banned == true) $('.replaychat .chatbox .head i').addClass('active');else $('.replaychat .chatbox .head i').removeClass('active');
  ...
  $('.replaychat .chatbox .head .action button.lockchat').click(function () {
    ...
    $.post("/admin/support/lockmessage", {
      ...
      if (data.status == 'closed') $(this).addClass('active');else $(this).removeClass('active');
    });
    if ($(this).hasClass('active')) $('.replaychat .chatbox .sendbox textarea').prop('disabled', true);else $('.replaychat .chatbox .sendbox textarea').prop('disabled', false);
  });
  $('.replaychat .chatbox .head i').click(function () {
    ...
    $.post("support/banuser", {
      ...
      if (data.success == true && data.banned == true) $(this).addClass('active');else $(this).removeClass('active');
    });
  });
  /* imdb */
    ...
    if (!patt.test(imdbid)) {
      ...
      $.get("/admin/imdb/init", {
        ...
        if (data.success == true) {
          ...
          if (data.data.cover) $('.layout .main .content .post .block.imdb .moviedata .avatar img').attr('src', data.data.cover);else $('.layout .main .content .post .block.imdb .moviedata .avatar img').attr('src', '');
          ...
          if (data.data.genre) $('.layout .main .content .post .block.imdb .moviedata .meta span.genre').text(data.data.genre.join(', '));else $('.layout .main .content .post .block.imdb .moviedata .meta span.genre').text('');
        } else {
          $('.layout .main .content .post .block.imdb .moviedata').fadeOut();
          if (data.message == 'http') toastr.error("Not found", "error");else toastr.error("Failed operation", "error");
        }
      });
    }
  });
  ...
  */
    ...
    if (!patt.test(imdbid)) {
      ...
      $.post("/admin/imdb/genre", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Genres");else toastr.error("Unsuccessful Operation", "Genres");
        }
      });
      ...
      $.post("/admin/imdb/country", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Countries");else toastr.error("Failed Operations", "Countries");
        }
      });
      ...
      $.post("/admin/imdb/language", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Languages");else toastr.error("Failed Operations", "Languages");
        }
      });
      ...
      $.post("/admin/imdb/poster", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Cover");else toastr.error("Failed Operation", "Cover");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Artists");else toastr.error("Failed Operation", "Artists");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Director");else toastr.error("Failed Operation", "Director");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Writer");else toastr.error("Failed Operations", "Writer");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("Not Found", "Composer");else toastr.error("Unsuccessful Operation", "Composer");
        }
      });
  ...
  $('.form-group.name_type select').change(function () {
    ...
    $('.layout .main .content .post .metabox.' + $(this).val() + ' select').each(function () {
      if ($(this).attr('name') == '') $(this).attr('name', $(this).data('name'));
    });
