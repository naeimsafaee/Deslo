...
*/
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.persianDatepicker = t() : e.persianDatepicker = t();
}(void 0, function () {
  return function (e) {
    function t(n) {
    ...
    !function (t, i) {
      ...
      n.SUPPORT = "wheel", n.ADD_EVENT = "addEventListener", n.REMOVE_EVENT = "removeEventListener", n.PREFIX = "", n.READY = !1, n.Instance = function (e) {
        ...
        remove: function remove(e, t, i, a) {
    ...
    */
    ...
    !function (i, s) {
      "object" == _typeof(t) && t && "string" != typeof t.nodeName ? s(t) : (a = [t], n = s, void 0 !== (o = "function" == typeof n ? n.apply(t, a) : n) && (e.exports = o));
    }(0, function (e) {
      function t(e) {
      ...
      function o(e, t) {
        return null != e && "object" != _typeof(e) && e.hasOwnProperty && e.hasOwnProperty(t);
      }
      ...
      function d(t, i) {
        ...
        for (var y, b, T, M, S, O, E = new h(t); !E.eos();) {
          if (y = E.pos, T = E.scanUntil(o)) for (var $ = 0, C = T.length; $ < C; ++$) {
            M = T.charAt($), r(M) ? v.push(m.length) : w = !0, m.push(["text", M, y, y + 1]), y += 1, "\n" === M && function () {
              if (p && !w) for (; v.length;) {
                delete m[v.pop()];
              } else v = [];
              p = !1, w = !1;
      ...
      h.prototype.eos = function () {
        ...
        if (n.hasOwnProperty(e)) i = n[e];else {
          for (var s, r, l, d = this, c = !1; d;) {
            if (e.indexOf(".") > 0) for (s = d.view, r = e.split("."), l = 0; null != s && l < r.length;) {
        ...
        if (l) {
          if (f(l)) for (var d = 0, c = l.length; d < c; ++d) {
            r += this.renderTokens(e[4], i.push(l[d]), n, a);
          } else if ("object" == _typeof(l) || "string" == typeof l || "number" == typeof l) r += this.renderTokens(e[4], i.push(l), n, a);else if (t(l)) {
