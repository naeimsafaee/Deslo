...
!function (e) {
  ...
  function r(e, t, n) {
    var r, a, o, s, i;
    return r = e.$element.offset(), a = e.$element.width(), o = e.$element.height(), s = Math.min(Math.max(t, r.left), r.left + a), i = Math.min(Math.max(n, r.top), r.top + o), {
      x: s,
      y: i
    };
  }
  ...
  t.prototype.uses = function (t) {
    ...
    if (t.stopPropagation(), (u.uses("swipe") && u.settings.preventDefault.swipe(u) || u.uses("drag") && u.settings.preventDefault.drag(u)) && t.preventDefault(), p > 2 && clearTimeout(u.timerTapAndHold), u.inDrag && o == u) {
      if (u.$element.trigger("drag", {
        ...
        if (u.settings.dropFilter !== !1) switch (l = _typeof(u.settings.dropFilter)) {
          case "string":
            if (u.settings.dropFilterTraversal) for (; i && !e(i).is(u.settings.dropFilter);) {
              i = i.parentElement;
            } else e(i).is(u.settings.dropFilter) || (i = null);
            break;

          case "function":
            if (u.settings.dropFilterTraversal) for (; i && u.settings.dropFilter(u.$element[0], i) !== !0;) {
              i = i.parentElement;
          ...
          default:
          case "boolean":
            if (u.settings.dropFilter === !0) for (; i.parentElement != u.$element[0].parentElement;) {
    ...
    var n = e(this);
    if (this.length > 1) for (var r = 0; r < this.length; r++) {
      e.touch(e(this[r]), t);
    ...
    if (s = e.extend(s, i), s = e.extend(s, o), "function" != typeof s.preventDefault.drag && (s.preventDefault.drag = s.preventDefault.drag === !0 ? function (e) {
      ...
      var u = function u(a) {
        var o = e(this),
            ...
            u = a.originalEvent.touches[0][s.coordinates + "Y"];
    ...
    if (s.useMouse) {
      ...
      var g = function g(r) {
        var o = e(this),
            i = n(o, t, s);
        return !i.ended && (a.triggerHandler("mouseup", r), i.doEnd(r, r[s.coordinates + "X"], r[s.coordinates + "Y"]), void (i.mouseDown = !1));
      };
