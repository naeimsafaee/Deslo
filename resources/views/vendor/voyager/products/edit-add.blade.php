...
@section('page_header')
    ...
    <a class="btn" target="_blank" href="/admin/color-to-products?key=product_id&filter=contains&s={{$dataTypeContent->slug}}">تغییر قیمت رنگ محصول</a>
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                <div class="form-group gray @if($row->type == 'select_dropdown' || $row->type == 'select_multiple' || $row->type == 'relationship') select @endif @if($row->type == 'hidden') hidden @endif {{ $errors->has($row->field) ? 'invalid' : '' }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                    ...
                                    @elseif ($row->type == 'relationship')
                                        @if($row->details->table == 'attribute_values')
                                            @php
                                            ...
                                            <div class="select">
                                                ...
                                                >
                                                    ...
                                                    @foreach($relationshipOptions as $relationshipOption)
                                                        <option value="{{ $relationshipOption->{$options->key} }}" @if(in_array($relationshipOption->{$options->key}, $selected_values)) selected="selected" @endif>{{ $relationshipOption->parent . ' : ' .$relationshipOption->{$options->label} }}</option>
                                                    @endforeach
