...
$(document).ready(function () {
  ...
  $('table tbody tr td input[type=checkbox]').click(function () {
    ...
    if ($(this).parents('table').find('tbody tr td input[type=checkbox]:checked').length > 1) $('.layout .main .header .action button.delete').text('حذف دسته جمعی');else $('.layout .main .header .action button.delete').text('حذف');
  });
    ...
    if (!patt.test(imdbid)) {
      ...
      $.get("/admin/imdb/init", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "خطا");else toastr.error("عملیات نا موفق", "خطا");
        }
      });
    }
  });
    ...
    if (!patt.test(imdbid)) {
      ...
      $.post("/admin/imdb/genre", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "ژانر ها");else toastr.error("عملیات نا موفق", "ژانر ها");
        }
      });
      ...
      $.post("/admin/imdb/country", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "کشور ها");else toastr.error("عملیات نا موفق", "کشور ها");
        }
      });
      ...
      $.post("/admin/imdb/language", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "زبان ها");else toastr.error("عملیات نا موفق", "زبان ها");
        }
      });
      ...
      $.post("/admin/imdb/poster", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "کاور");else toastr.error("عملیات نا موفق", "کاور");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "هنرمندان");else toastr.error("عملیات نا موفق", "هنرمندان");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "کارگردان");else toastr.error("عملیات نا موفق", "کارگردان");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "نویسندگان");else toastr.error("عملیات نا موفق", "نویسندگان");
        }
      });
      ...
      $.post("/admin/imdb/casts", {
        ...
        if (data.success == true) {
          ...
          if (data.message == 'http') toastr.error("یافت نشد", "آهنگساز");else toastr.error("عملیات نا موفق", "آهنگساز");
        }
      });
