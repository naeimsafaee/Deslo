                            ...
                            <div class="white-box blog-item blog-single-item">
                                <div class="row">
                                    <div class="padding-left-item col-lg-7 col-md-6 col-sm-12">
                                        ...
                                        <p>
                                            {{setting('texts.new_regulate_text')}}
                                        </p>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="installment flex-box add-order">
                                                        <h4>
                                                            فرم درخواست <span>کوک و رگلاژ</span>
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <form id="main_form" method="POST"
                                                          action="{{ route('new_regulate_submit') }}">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="input-row">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="input-row">
                                                                    ...
                                                                    <input class="padding-left datepicker" type="text"
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="input-row">
                                                                    ...
                                                                    <textarea type="text" name="type">{{old('type')}}</textarea>
                                                                </div>
                                                                @error("type")
                                                                <span style="color:red">
                                                                        {{ $message }}
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <button type="submit" class="submit-button button flex-box">
